...
@Component({
  ...
  templateUrl: './available-date-view-page.component.html',
  styleUrls: ['./available-date-view-page.component.css']
})
export class AvailableDateViewPageComponent implements OnInit {
